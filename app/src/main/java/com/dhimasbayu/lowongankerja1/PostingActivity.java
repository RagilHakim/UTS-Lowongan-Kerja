...
import com.dhimasbayu.lowongankerja1.adapters.PostingAdapter;
import com.dhimasbayu.lowongankerja1.databases.SqliteDatabaseHelper;
import com.dhimasbayu.lowongankerja1.models.Constant;
import com.dhimasbayu.lowongankerja1.models.Posting;
import com.dhimasbayu.lowongankerja1.models.Session;
import com.dhimasbayu.lowongankerja1.models.Settings;
...
//        Toast.makeText(this,message, Toast.LENGTH_LONG).show();
        if (res.moveToFirst()){
            do{
                ...
                postings.add(new Posting(id,judul,deskripsi,persyaratan,gaji,tanggal,gambar));
