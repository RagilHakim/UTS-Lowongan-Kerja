    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(icon.equalsIgnoreCase("red")){
                    icon = "icon_red";
                }else if(icon.equalsIgnoreCase("blue")){
                    icon = "icon_blue";
                }else if(icon.equalsIgnoreCase("yellow")){
                    icon = "icon_yellow";
                ...
                boolean status = db.updateDataPosting(data.getId(),eTjudul.getText().toString(), eTdeskripsi.getText().toString(), eTpersyaratan.getText().toString(),
                        eTgaji.getText().toString(), eTtanggal.getText().toString(), icon);
                if(status){
